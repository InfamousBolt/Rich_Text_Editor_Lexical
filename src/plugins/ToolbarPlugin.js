...
// import ActionsPlugin from "./ActionsPlugin.tsx";
import { ReactComponent as FormattingOptions } from '../formattingOptions.svg'
import styles from "../commentBox.module.scss";
import { IconButton, Panel} from '@informatica/droplets-core';
...
const handleClearContent = (editor) => {
  editor.update(() => {
    const root = $getRoot();
...
export default function ToolbarPlugin(props) {
  ...
  const isDescription = props.showAs==="description";
      ...
      {blockType === "code" ? (
        ...
        <>
          {/* <div className="drop-down-1"> */}
            ...
            >
              <FormattingOptions className={styles.formattingOptionsIcon} />
            </IconButton>}
            {/* <ul className="dropdown-menu mt-2 p-0"> */}
              {/* <ul className="list-group list-group-horizontal"> */}
                {/* <li className="dropdown-item list-group-item p-0 border-top-0 border-bottom-0 border-left-0"> */}
                  <button
                    onClick={() => {
                ...
                {/* </li> */}
                {/* <li className="dropdown-item list-group-item p-0 border-0"> */}
                  <button
                    onClick={insertLink}
          ...
          <div className="drop-down-2">
            <button className="toolbar-item spaced" data-bs-toggle="dropdown" data-bs-auto-close="false">
          ...
          <Divider />
          <button
            onClick={() => handleClearContent(editor)
            }
            className="toolbar-item"
